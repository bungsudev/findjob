		...
		<div class="row">
			...
			<div class="col-lg-4 d-flex justify-content-center">
				<div class="signupBox mt-5 mb-5 text-center">
					...
					<a href="#"><img class="mt-4 imgScale" src="assets/images/login/promotion.svg"
							alt="Daftar kerja di FindJob" width="100px">
						<button class="btn btn-info btn-block mx-auto btn200 mt-4 mb-2">MULAI MENCARI KERJA</button>
					</a>
			...
			<div class="col-lg-4  d-flex justify-content-center">
				<div class="signupBox mt-5 mb-5 text-center">
					...
					<a href="#"><img class="mt-4 imgScale" src="assets/images/login/enterprise.svg"
